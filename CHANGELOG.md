...
- Added All Tools dashboard with client-side search.
...
## v2.0 Sprint 3 - Document Workspace Expansion
- Added business workspace dashboard at `/workspace/`.
- Added Purchase Order Generator.
- Added Estimate Generator.
